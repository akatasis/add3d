...
GALLERY = [
    ...
    ("castle.png", "46_castle.py",
     ...
     "two moored ships, a palace with glass windows, a Romanesque porch and a "
     "tiled roof, a chapel with stained glass and rose windows, a courtyard "
     "full of knights on foot and on horseback, archers, townsfolk, log "
     ...
     "dviem prišvartuotais laivais, rūmai su stiklo langais, romaniniu "
     "prieangiu ir čerpių stogu, koplyčia su vitražais ir rožės langais, "
     "kiemas pilnas riterių pėsčiomis ir raitų, lankininkų, miestiečių, "
